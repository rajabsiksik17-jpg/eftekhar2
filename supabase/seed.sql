...
begin
  ...
  (home_id, 'video_content',
    ...
    null, null,
    '{"ar":{"text":"نقدم لكم لمحة عن خدماتنا وطريقة عملنا في عيادات افتخار، حيث نجمع بين الخبرة الطبية والتقنيات الحديثة لتقديم تجربة علاجية متكاملة."},"en":{"text":"A glimpse into our services and how we work at Eftekar Clinics, where medical expertise meets modern technology for a complete care experience."},"video":{"youtube_url":"","thumbnail":"","autoplay":false,"muted":true,"loop":false,"controls":true,"overlay":true,"modal":true},"features":[{"icon":"Stethoscope","ar":"فريق طبي متخصص","en":"Specialized Medical Team"},{"icon":"Cpu","ar":"تقنيات حديثة","en":"Modern Technology"},{"icon":"HeartHandshake","ar":"رعاية متكاملة","en":"Integrated Patient Care"},{"icon":"ShieldCheck","ar":"خصوصية وأمان","en":"Privacy & Safety"}],"cta":{"label_ar":"احجز موعد","label_en":"Book Appointment","url":"/appointment"}}'::jsonb, 0),
  (home_id, 'service_categories',
    ...
    '{}'::jsonb, 4),
  (home_id, 'promotional_slider', null, null, null, null, '{}'::jsonb, 5),
  (home_id, 'before_after', null, null, null, null, '{}'::jsonb, 6),
  (home_id, 'doctors',
  ...
  (home_id, 'way_to_clinic',
    ...
    '{"ar":{"text":"شاهد الفيديو للتعرف على الطريق والوصول إلى العيادة بسهولة."},"en":{"text":"Watch the video to learn the route and reach the clinic easily."},"video":{"youtube_url":"","thumbnail":""}}'::jsonb, 10),
  (home_id, 'final_cta',
    ...
    '{"cta":{"label_ar":"احجز موعد","label_en":"Book Appointment","url":"/appointment"}}'::jsonb, 11)
  on conflict do nothing;
end $$;
