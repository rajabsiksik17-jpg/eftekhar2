...
('lamees-al-zoubi','لميس محمد الزعبي','Lamees Mohammad Al-Zoubi','management',null,null,'المدير المالي','Finance Manager','لميس محمد الزعبي، المدير المالي في عيادات افتخار.','Lamees Mohammad Al-Zoubi, Finance Manager at Eftekar Clinics.',false,6,null,null,null,null)
on conflict (slug) do nothing;
